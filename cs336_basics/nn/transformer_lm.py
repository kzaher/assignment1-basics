...
class TransformerLm(nn.Module):
  ...
  def forward(self, in_indices: Int[Tensor, '...  batch_size sequence_length'], token_positions: Int[Tensor, '...  batch_size sequence_length'] | None = None) -> Float[Tensor, '... batch_size sequence_length vocab_size']:
    propagate: Float[Tensor, '... batch_size sequence_length d_model'] = self.token_embeddings(in_indices)
